...
{
    public class TrainInstanceMapper : UpdatableEntityMapper<long, TrainInstance>
    {
        ...
        protected override TrainInstance CreateEntity(long key)
        {
            return new TrainInstance(key);
        }
